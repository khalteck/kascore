...
const StandingsTable = ({ teamId, standings }) => {
  ...
  return (
    <div className="w-full min-h-[300px]">
      ...
      <div className="w-full flex flex-col gap-3 mt-5 text-[.85rem] border border-black/10 dark:border-white/10 p-3 rounded-md">
        <div className="flex gap-2 items-center">
          <div className="w-3 h-3 rounded-sm bg-orange-500"></div>
          <p>{categories[0]}</p>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-3 h-3 rounded-sm bg-orange-500/50"></div>
          <p>{categories[1]}</p>
        </div>
        <div className="flex gap-2 items-center">
